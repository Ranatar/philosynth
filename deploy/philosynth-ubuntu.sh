...
#  - миграций ДЕВЯТЬ (0000…0008): 0006 — почта (9.1), 0007 — рекомендации
#    критики (10.1), 0008 — дерево генеалогии импортированного файла
#    (2026-09-21, вне бесед); шаблонов 263 (10.1: + шаблон «Таблицы рекомендаций» и
...
step_db_content() {
  ...
  ok "сиды прогнаны (263 шаблона, 27 конфигов, 18+29 типов таксономии)"
