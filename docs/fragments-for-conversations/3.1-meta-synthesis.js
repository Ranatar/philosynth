...
// scripts/extract-by-name.py по спецификации 3.1-meta-synthesis.spec.
//
...
// ───── Родительский контекст: константы (спец. 01-architecture §4.13) · var:PARENT_FIELD_ORDER
// philosynth.html строки 9872–9878 ─────
...
// ───── Родительский контекст: константы (спец. 01-architecture §4.13) · var:PARENT_FIELD_LABELS
// philosynth.html строки 9879–9891 ─────
...
// ───── Родительский контекст: константы (спец. 01-architecture §4.13) · var:PARENT_DEPS_BASE
// philosynth.html строки 9896–9921 ─────
...
// ───── Родительский контекст: константы (спец. 01-architecture §4.13) · var:PARENT_DEPS_LEVEL
// philosynth.html строки 9947–9967 ─────
...
// ───── Родительский контекст: константы (спец. 01-architecture §4.13) · var:PARENT_INTRA_DEPS
// philosynth.html строки 10023–10050 ─────
...
// ───── Родительский контекст: константы (спец. 01-architecture §4.13) · var:PARENT_CONTEXT_SCHEMA_ID
// philosynth.html строки 10053–10053 ─────
      const PARENT_CONTEXT_SCHEMA_ID = "selective-v1";

// ───── Родительский контекст: константы (спец. 01-architecture §4.13) · var:PARENT_CONTEXT_SCHEMA_VERSION
// philosynth.html строки 10051–10052 ─────

      const PARENT_CONTEXT_SCHEMA_VERSION = 1;

// ───── Сборка родительского контекста · js:conceptContextBlockFull
// philosynth.html строки 10232–10258 ─────
...
// ───── Сборка родительского контекста · js:conceptContextBlockSelective
// philosynth.html строки 10259–10300 ─────
...
// ───── Сборка родительского контекста · js:resolveParentDeps
// philosynth.html строки 10091–10109 ─────
...
// ───── Сборка родительского контекста · js:resolveParentDepsForSubsection
// philosynth.html строки 10114–10131 ─────
...
// ───── Сборка родительского контекста · js:parentFieldsUsedFor
// philosynth.html строки 10181–10195 ─────
...
// ───── Сборка родительского контекста · js:buildParentSpecForLog
// philosynth.html строки 10196–10231 ─────
...
// ───── Сборка родительского контекста · js:_validateParentDeps
// philosynth.html строки 10054–10089 ─────
...
// ───── Участники-концепции · js:importConceptAsParticipant
// philosynth.html строки 22009–22176 ─────
...
// ───── Участники-концепции · js:isPlaceholderConceptName
// philosynth.html строки 22228–22237 ─────
...
// ───── Участники-концепции · js:resolveConceptName
...
// ───── Генеалогия (server/services/lineage-service.ts) · js:checkGenealogyOverlaps
...
// ───── Генеалогия (server/services/lineage-service.ts) · js:collectPhilosopherAncestors
// philosynth.html строки 22451–22461 ─────
...
// ───── Генеалогия (server/services/lineage-service.ts) · js:normalizeGenealogyNames
...
// ───── Генеалогия (server/services/lineage-service.ts) · js:reconstructGenealogy
