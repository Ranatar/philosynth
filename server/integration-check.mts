...
// payload той же схемой, что constructWebhookEvent (t=…,v1=hmac-sha256).
{
  ...
  const envEx = await rd("../.env.local.example");
  ...
  if (!/^\.dev-billing\/$/m.test(await rd("../.gitignore"))) errs.push("4ak: .dev-billing/ не в .gitignore");
}
